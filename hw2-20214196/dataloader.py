...
class Summer2WinterDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_A = Image.open(self.path_A + '/' + self.image_list_A[index % len(self.image_list_A)])
        image_B = Image.open(self.path_B + '/' + self.image_list_B[random.randint(0, len(self.image_list_B) - 1)])
        ### END YOUR CODE
